// VENDORED VERBATIM from github.com/xt4d/GameBlocks
//   gameblocks/modules/math/WorldBasis.js  (MIT)
// Relative path PRESERVED (src/gameblocks/modules/math/...) so any sibling
// module copied in later keeps resolving its own relative imports unchanged.
//
// This is the coordinate SOURCE OF TRUTH. All direction/facing math routes
// through it - that is what prevents the class of bug where a character runs
// backwards because a sign was fixed locally instead of at the basis.
//
// Floppy Bird 3D uses the DEFAULT basis: right=+x, up=+y, forward=-z.
// The world scrolls toward -x; the camera sits on +z looking along forward, so
// the z=0 plane is the screen plane and the 2D layout maps 1:1.
//
// DO NOT EDIT. Adapt by composing, not by patching.
